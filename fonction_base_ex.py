...
bob_2 = translation(bob, np.array([100,100,100]))
bob_3 = translation(bob, np.array([200,200,200]))
bob_4 = translation(bob, np.array([300,300,300]))
bob_turns = rotation(bob, np.pi, "x")
bob_centers = centrer(bob)
bob_scales = homot(bob, 3)

final = fusion(bob, bob_2, bob_3, bob_4, bob_turns, bob_centers, bob_scales)
EcrireSTLASCII("mutli_bob.stl",final[0],final[1],final[2])
